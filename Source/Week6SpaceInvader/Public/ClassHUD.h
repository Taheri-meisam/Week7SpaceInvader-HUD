...
public:
	...
	APlayerShip* PlayerShipPtr2 = Cast<APlayerShip>(UGameplayStatics::GetPlayerPawn(GetWorld(), 0));
	//AWeek6SpaceInvaderGameModeBase* GameModePtrs = GetWorld()->GetAuthGameMode<AWeek6SpaceInvaderGameModeBase>();
	AWeek6SpaceInvaderGameModeBase* GameModePtr2 = Cast<AWeek6SpaceInvaderGameModeBase>(UGameplayStatics::GetGameMode(GetWorld()));
